...
janela =Tk()
janela.title("Cha de pika")
janela.geometry("235x317")
...
b_2.place(x=118, y=0)
b_3 = Button(frame_corpo, command= lambda: entrar_valores('/'), text="/", width=5, height=2, bg=cor5, fg=cor1, font=('Ivy 13 bold'), relief=RAISED, overrelief= RIDGE)
b_3.place(x=177, y=0)
...
b_14 = Button(frame_corpo, command=calcular, text="=", width=5, height=2, bg=cor5, fg=cor1, font=('Ivy 13 bold'), relief=RAISED, overrelief= RIDGE)
